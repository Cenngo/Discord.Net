...
namespace Discord.Rest
{
    internal static class ClientHelper
    {
        ...
        public static async Task<IReadOnlyCollection<RestGlobalCommand>> GetGlobalApplicationCommandsAsync(BaseDiscordClient client, bool withLocalizations = false, string locale = null,
